...
!(function (e, t) {
    ...
    const Ae = (t, o) => {
        ...
        Le = (t, i) => {
            ((e, t) => {
                const n = g(),
                    o = b();
                t.toast ? (W(n, "width", t.width), (o.style.width = "100%"), o.insertBefore(E(), y())) : W(o, "width", t.width),
        ...
        qt = (t, n) => {
            ...
            if ((o.showLoaderOnDeny && xt(x()), o.preDeny)) {
                ...
                Promise.resolve()
                    ...
                    .then((e) => {
                        !1 === e ? (t.hideLoading(), it(t)) : t.close({ isDenied: !0, value: void 0 === e ? n : e });
                    })
    ...
    const An = (t, n, o) =>
        ...
        Bn = (t) => {
            const n = { popup: b(), container: g(), actions: $(), confirmButton: B(), denyButton: x(), cancelButton: P(), loader: E(), closeButton: L(), validationMessage: k(), progressSteps: A() };
